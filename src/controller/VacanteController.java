...
public class VacanteController {
    ...
    public static void update(){
        ...
        String duracion = JOptionPane.showInputDialog("Ingrese la descripcion de la vacante", objVacante.getDescripcion());
        String estado = JOptionPane.showInputDialog("Ingrese la descripcion de la vacante", objVacante.getDescripcion());
